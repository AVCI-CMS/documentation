...
- **Category:** Assign to a hierarchical category (from [Common Categories](../common/categories)). E.g., `Electronics > Smartphones`.
- **Slug:** The URL path for the product page. Auto-generated if left blank.
- **Brand:** Link the product to a specific brand (from [Relations > Brands](../relations/brands)).
...
- If a product comes in different sizes, colors, or materials, you define them here using the [Common Attributes](../common/attributes) module.
